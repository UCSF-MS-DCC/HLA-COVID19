class QueryController < ApplicationController
    ...
    def import_hla
        puts "IMPORT HLA PARAMS: #{import_params}"
        # message = ""
    ...
    def import_params
        params.permit(:origin_identifier, :project_name, :drb1_1, :drb1_2, :dqb1_1, :dqb1_2, :dpb1_1, :dpb1_2, :a_1, :a_2, :b_1, :b_2, :c_1, :c_2,
                    ...
                    :typing_method_name, :typing_method_version, :gl_string, :novel_polymorphisms, :pop, :a_prob, :a_matching, :b_prob, :b_matching, :c_prob, :c_matching,
